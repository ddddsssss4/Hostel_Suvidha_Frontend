        ...
        <>
          ...
          <div className="flex flex-col md:flex-row w-full relative z-10">
            ...
            <div className="flex flex-col w-full md:w-[60%] p-4 relative z-10">
              ...
              <div className="w-full md:w-[full] bg-[#202528] rounded-xl overflow-x-auto shadow-black overflow-y-auto custom-scroll">
                  ...
                  {messages.map((message, index) => (
                    <div key={index} className="flex space-x-4 items-start">
                      <div className="relative">
                        ...
                        ></div>
                        {message.isActive && (
                          <span className="absolute bottom-0 right-0 block w-3 h-3 rounded-full ring-2 ring-[#FF824C] bg-[#22C55E]" />
                        )}
                      </div>
                      <div>
