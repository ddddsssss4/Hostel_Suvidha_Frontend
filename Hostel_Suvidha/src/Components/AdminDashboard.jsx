...
const AdminDashboard = () => {
    const [complaints, setComplaints] = useState([
        ...
        { "type": "Washroom", "complaintID": "12358", "status": "Completed" },
        { "type": "Hostel", "complaintID": "12359", "status": "Declined" },
        { "type": "Furniture", "complaintID": "12367", "status": "Pending" },
        { "type": "Laundary", "complaintID": "12368", "status": "Pending" },
        { "type": "ELECTRONIC", "complaintID": "12457", "status": "Pending" },
        { "type": "ELECTRONIC", "complaintID": "12657", "status": "Pending" },
        { "type": "Furniture", "complaintID": "12757", "status": "Pending" },
        { "type": "Furniture", "complaintID": "12857", "status": "Pending" },
        { "type": "Furniture", "complaintID": "12957", "status": "Pending" },
            { "type": "Furniture", "complaintID": "12157", "status": "Pending" },
      ]);
            ...
            <div className="w-full md:w-[40%] p-4 relative z-10 pr-8">
              <div className="flex justify-end items-center gap-3">
                <div className="text-white font-extrabold text-lg">
                  <span className='text-[#FF824C] text-sm'>ADMIN </span>
                  <br />
                  AMAN KUMAR
                </div>
