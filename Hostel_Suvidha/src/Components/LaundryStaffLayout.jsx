    ...
    <div className="flex h-screen bg-[#181A1E]">
      ...
      <nav className="hidden lg:block w-[23%] text-white relative">
        ...
        <ul className='pt-32 text-white font-poppins text-lg '>
          <NavLinkItem to="/laundry/staff/dashboard" label="Dashboard"/>
          <NavLinkItem to="/laundry/staff/complaints" label="Complaints" />
        </ul>
...
export default LaundryStaffLayout;
